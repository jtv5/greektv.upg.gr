...
<form class="form-signin form-horizontal m-t-20" name="form1" method="post" action="checklogin.php">
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input name="myusername" id="myusername" class="form-control" type="text" required="" placeholder="Username" autofocus>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-xs-12">
                                <input name="mypassword" id="mypassword" class="form-control" type="password" required="" placeholder="Password">
                            </div>
                        </div>
<!--
...
-->
                        <div class="form-group text-center m-t-30">
                            <div class="col-xs-12">
                                <button name="Submit" id="submit" class="btn btn-lg btn-primary btn-block waves-effect waves-light" type="submit">Log In</button>
                            </div>
                        </div>
                          <div id="message"></div>
<!--
